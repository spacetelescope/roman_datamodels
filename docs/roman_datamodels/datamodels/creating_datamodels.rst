...
contains the provided `roman_datamodels.datamodels.TaggedObjectNode`. This is used when
...
`roman_datamodels.datamodels.TaggedObjectNode`. However this is less useful for pipeline
