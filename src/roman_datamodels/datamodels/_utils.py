...
from roman_datamodels._stnode import REGISTRY, TaggedScalarNode
...
def rdm_open(init, memmap=False, **kwargs):
    ...
    if (model_type := type(asdf_file.tree["roman"])) in REGISTRY.datamodels:
        return REGISTRY.datamodels[model_type](asdf_file, **kwargs)
